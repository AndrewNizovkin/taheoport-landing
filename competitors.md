...
- **Описание:** Разработка и распространение ПО

- **Продукт:** ГИС Панорама

  - Стоимость лицензии  для Ubuntu 20.04, 22.04 на 1год 62730руб, 3года 139400руб

[Оффициальный сайт](https://gisinfo.ru/geodesy/plan.htm)

#### Функции программного обеспечения:

- оцифровка (векторизация) сканированного изображения карт и планов;

- составление цифровых планов по результатам геодезических изысканий;

- создание объектов цифровой карты различными методами;

- редактирование метрики объектов ручными и автоматизированными методами;

- автоматическое создание объектов со сложным графическим представлением;

- обеспечение функций топологического согласования объектов цифрового плана;

- поддержка процедур автоматического контроля и редактирования карты.

- развитый модуль Геодезия
